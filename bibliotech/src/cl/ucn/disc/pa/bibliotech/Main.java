...
public final class Main {
    ...
    private static void menuPrincipal(final Sistema sistema) {
        ...
        while (!Objects.equals(opcion, "4")) {
            ...
            switch (opcion) {
                ...
                case "3" -> calificarLibro(sistema);// case "3" -> TODO: Crear metodo de calificar libro.
    ...
    private static void calificarLibro(Sistema sistema) {
        ...
        sistema.buscarLibroCalificar(isbn,poscionLibro);

        StdOut.println(poscionLibro);

        sistema.calculoCalificacion(poscionLibro);
    ...
    private static void cambiarContrasenia(Sistema sistema) {
        ...
        // TODO: implementar este metodo LISTO
    }

    private static void editarCorreo(Sistema sistema) {
        StdOut.println("Ingrese la direccion de correo nueva:");
